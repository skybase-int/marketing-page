...
Some Star Agent Artifacts are high-level, focusing on vision, principles and community culture, while others are highly detailed, outlining the management of specific ongoing tasks or relationships.`,
  ...
  {
    question: 'How do Stars Agents benefit the Sky Ecosystem?',
    answer:
      'Sky Star Agents are autonomous and independent decentralized projects within the Sky Ecosystem. They operate within the Sky Agent Framework, which is designed to foster innovation, expand liquidity, and help grow the Sky Ecosystem.',
    categories: ['Sky Stars']
  },
  {
