...
Subject to Sky Ecosystem Governance approval, you might soon be able to access Sky Token Rewards on other blockchains with reduced transaction costs. Note that if you have shied away from the Ethereum blockchain due to the high price of gas, the average price of gas on Ethereum has dropped significantly as a result of the 2024 Dencum upgrade.`,
    categories: ['Sky Token Rewards']
  },
  {
    question: 'How do I claim my Sky Token Rewards in the Sky.money web app?',
    answer: `To claim your Sky Token Rewards using the Sky.money web app, click on the Claim button in the Rewards feature of the app. You must claim all your Sky Token Rewards at once. It is not possible to claim partial rewards.`,
    categories: ['Sky Token Rewards']
  }
];
