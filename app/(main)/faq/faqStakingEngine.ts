...
For more information, see the [User Risk Documentation](https://docs.sky.money/user-risks).`,
  ...
  },
  {
    ...
    answer: `Yes, but only via [Spark](https://spark.fi)'s Borrow feature, not via the [Sky.money web app](https://app.sky.money). 
